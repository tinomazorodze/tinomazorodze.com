...
export default function CommentSection() {
  ...
  return (
    <aside className="mt-20">
      <h2 className="mb-8 text-3xl">Comment Section</h2>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              ...
              >
                Comment on whatsapp.
                <LaunchIcon className="inline h-4 w-4" />
              </Link>
            </p>
          </div>
        </div>
      ...
      <div className="flex items-start space-x-4">
        ...
        <div className="min-w-0 flex-1">
          <form action="#" className="relative">
            <div className="overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-teal-600 dark:ring-gray-600">
              ...
              <textarea
                ...
                name="comment"
                id="comment"
                className="block w-full resize-none border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 dark:text-white"
