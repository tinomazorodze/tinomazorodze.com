...
import logoZimdevelopers from '@/images/logos/zimdevelopers.svg'
    ...
    <li className="flex gap-4">
      ...
      <dl className="flex flex-auto flex-wrap gap-x-2">
        ...
        <dd className="text-xs text-zinc-500 dark:text-zinc-400">
          <Link href={role.link.href} className="hover:underline">
            {role.link.display}
          </Link>
        </dd>
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Zim Developers Labs',
      link: {
        display: 'zimdevelopers.com',
        href: 'https://www.zimdevelopers.com',
      },
      logo: logoZimdevelopers,
      start: '2024',
      end: {
        label: 'Present',
        dateTime: new Date().getFullYear().toString(),
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Current Projects</span>
      </h2>
    ...
    <div className="mt-16 sm:mt-20">
      <div className="-my-4 flex justify-center gap-5 overflow-hidden py-4 sm:gap-8">
        {[
          ...
          {
            src: image3,
            alt: 'Tino Mazorodze in 2024',
          },
          {
            src: image4,
            alt: 'TechTinoe (IRL: Tino Mazorodze) Steam Profile',
          },
          {
            src: image5,
            alt: 'IBZIM in 2024',
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Software developer, gamer, and tech enthusiast.
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Tino, a software developer, gamer, and tech enthusiast based in
            Harare, Zimbabwe. I’m the current CEO of Xfinity Pros, the makers of
            IBZIM.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://x.com/TechTinoe"
