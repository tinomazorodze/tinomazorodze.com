...
import logoDewsonConstruction from '@/images/logos/dewson-construction.svg'
import logoMazTech from '@/images/logos/maztech.svg'
...
function WhatsappIcon(props: React.ComponentPropsWithRef<'svg'>) {
  return (
  ...
  return (
    ...
    >
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        <WhatsappIcon className="h-6 w-6 flex-none fill-zinc-400" />
        <span className="ml-3">Connect with Tino</span>
      </h2>
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Dewson Construction',
      title: 'Web Designer',
      logo: logoDewsonConstruction,
      start: 'Feb 2024',
      end: 'May 2024',
    },
    {
...
export default async function Home() {
  let articles: ArticleType[] = (await getAllArticles()).slice(0, 4)
