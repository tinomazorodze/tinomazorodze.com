      ...
      <div className="space-y-20">
        <ToolsSection title="Workstation">
          <Tool title="OMEN 45L, NVIDIA® GeForce 4090, Core i9-13, 64GB DDR5 RAM">
            I was using a Dell G3 GeForce 1050 prior to this and the difference
            is night and day. I’ve never heard the fans turn on a single time,
            even under the incredibly heavy loads I put it through with our
          ...
          <Tool title="Samsung Odyssey 4K Ark Monitor">
            ...
            puts you in the action like nothing else. Curved to match the human
            eye and minimize strain so you can get lost in whatever world you
            call home.
          </Tool>
        </ToolsSection>
        <ToolsSection title="Development tools">
          <Tool title="Visual Studio Code">
            The best all in one code editor on the internet. Add some extensions
            and it will become unstoppable. The best part is its 100% free.
          </Tool>
          <Tool title="Notepad">
        ...
        <ToolsSection title="Design">
          <Tool title="Figma">
            I was an AdobeXD fan until Adobe decided to buy Figma and drop XD. I
            was mad for a while but I&#39;m coming to realize it was a good
