          ...
          <div className="lg:order-first lg:row-span-2">
            ...
            <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
              <p>
                ...
                When I turned 8 I got my first Computer and thats when things
                went wrong😂. I spent most of my time browsing on the internet
              ...
              <p>
                ...
                am focused on frontend development and working on open-source
                projects. Hopefully someday one of these projects might turn
                into something big with the help of contributions from other
                developers.
              </p>
              <p>
                ...
                steep learning curve. Even thought I hate it with a passion,
                Dota 2 is my number 1 favourite game. I play Dota 2 everyday and
                its been painful being stuck in Herald if you know what i mean.
                Apart from Dota I usually play business simulators like Software
                Inc and Big Ambitions.
              </p>
              <p>
                Right now I am a Software Engineering student at the University
                of Zimbabwe. I just started my 4 year course but I will
                regularly post content on my blog,{" "}
                <Link
                  href="https://www.youtube.com/@techtinoe"
