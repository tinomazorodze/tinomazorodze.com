...
import logoZimClassroom from '@/images/logos/zim-classroom.svg'
...
const projects = [
  {
    name: 'Zim Classroom',
    description:
      'All in one study pack for ZIMSEC Students. The best E-Learning platform on the internet',
    link: { href: '#', label: 'zimclassroom.com' },
    logo: logoZimClassroom,
  },
  {
    name: 'Wealth Hub',
    description:
    ...
    link: {
      href: 'https://www.instagram.com/wealthhub.hq/',
      label: '@wealthhub.hq',
    },
    logo: logoWealthHub,
  },
...
export const metadata: Metadata = {
  title: 'Projects',
  description: 'Things Tino made trying to put his dent in the universe.',
}
        ...
        {projects.map((project) => (
          <Card as="li" key={project.name}>
            ...
            <h2 className="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
              <Card.Link href={project.link.href} rel="nofollow">
                {project.name}
              </Card.Link>
            </h2>
